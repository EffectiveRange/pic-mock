...
struct timer_state_t {
    ...
    // latched in from time_ms when client arms timer
...
void timers_initialize() {
    ...
    tmr_wheel_PeriodSet(TMR0_MAX_COUNT - 999);
    tmr_wheel_Write(TMR0_MAX_COUNT - 999);
